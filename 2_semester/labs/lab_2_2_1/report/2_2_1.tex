...
\begin{document}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title={Зависимость напряжения на диагонали моста от времени},
            grid=both,
    ...
    Аппроксимируя зависимость $U(T)$ с помощью функции времени: $U_0 e^{-t/\tau}$ получим следующие значения $\tau$:
    \begin{eqnarray*}
        41 \ &\text{торр}:&\  \tau = 370.5 \ \text{с} \\
        48.5 \ &\text{торр}:&\  \tau = 445.1 \ \text{с} \\
        59.5 \ &\text{торр}:&\  \tau = 517.8 \ \text{с} \\
        82 \ &\text{торр}:& \ \tau = (698.3\pm 0.3) \ \text{с}\\
        119 \ &\text{торр}:& \ \tau = (996.4\pm 1.4) \ \text{с}\\
        201 \ &\text{торр}:& \ \tau = (1651.7\pm 1.6) \ \text{с}
    \end{eqnarray*}
    По формуле \eqref{tau} получим значения коэффициента диффузии при различных давлениях и построим его зависимость в осях $D(1/p)$:
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1.3]
            \begin{axis}[name=plot1,
                title={Зависимость коэффициента диффузии от $1/p$},
                xlabel={$1/p$, торр$^{-1}$},
                ylabel={$D$, см$^2$/с},
                ...
                xmajorgrids=true,
                grid style=dashed,]
                \addplot[] coordinates {( 0.024390243902439025 , 8.90609718064785 )
                ( 0.020618556701030927 , 7.413953619706759 )
                ( 0.01680672268907563 , 6.3729082402188055 )
                ( 0.012195121951219513 , 4.72597372908642 )
                ( 0.008403361344537815 , 3.3118601712847684 )
                ( 0.004975124378109453 , 1.9907390448908102 )

                };
                \addlegendentry{$D(1/p)$}
                \addplot[green,dashed,domain=0.4E-2:2.6E-2] {350.6*x+0.347};
