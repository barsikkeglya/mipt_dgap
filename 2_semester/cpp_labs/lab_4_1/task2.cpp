...
int main(){
    ...
    for(unsigned int n = start_n; n < max_n; n+=step){
        ...
        output_file << n << "," << init_timeA << "," << search_timeA << "," << delete_timeA << "," << init_timeB << "," << search_timeB << "," << delete_timeB << endl;
    }
